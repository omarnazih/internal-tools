...
const Lantern = () => (
    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="animate-swing">
        <path
    ...
    return (
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 flex flex-col items-center gap-2">
            <div className="flex items-center gap-4">
                <CrescentMoon />
                <div
                    className={`text-3xl font-arabic font-bold transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-60'
                        }`}
                    style={{
                        color: '#FFD700',
